...
/**
 * Class that corresponds to struct SparseVectorJNA in C++. It is only used for JNA to transmit data
 * between Java and C++.
 */
@FieldOrder({"n", "indices", "values", "length"})
public class SparseVectorJNA extends Structure {
    public static class ByValue extends SparseVectorJNA implements Structure.ByValue {}
